...
// We define these variables at the top level, but we assign them ONLY after the page loads
...
function onUploadExcelClick(e) {
    ...
    excelInput.click();           // open file dialog
}
...
// This listener ensures we only search for HTML elements AFTER the page is ready.
document.addEventListener('DOMContentLoaded', () => {
    // 1. Select the DOM elements now that they exist
